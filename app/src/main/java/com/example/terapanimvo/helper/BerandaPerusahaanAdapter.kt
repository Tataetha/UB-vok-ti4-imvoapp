...
class BerandaPerusahaanAdapter(
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        if (holder.textViewNama.lineCount != 1)
            holder.textViewAlamat.maxLines = 2
        else
            holder.textViewAlamat.maxLines = 3
    }
}
